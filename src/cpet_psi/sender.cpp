 ...
 * @brief Sender 클래스의 멤버 함수를 구현하는 소스 파일입니다.
 */
...
/**
 * @brief Sender 클래스의 기본 생성자입니다.
 * * Sender my_sender; 와 같이 객체를 생성할 때 호출됩니다.
